 ...
 * @author USER
 */
public class chunk8q implements ActionListener{
    JFrame frame;
    JLabel label;
    JButton d;
    JButton p;
    ...
    public void MainCodeBlock() {
        ...
        label = new JLabel("What is the chemical formula for water?", SwingConstants.CENTER);
    ...
    public boolean startdaquestion8() {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(chunk8q::new);
    }
}