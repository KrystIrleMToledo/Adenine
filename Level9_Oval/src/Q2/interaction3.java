 ...
 * @author USER
 */
public class interaction3 implements ActionListener{
    JFrame frame;
    JLabel label;
    JButton x;
    JButton but1;
    ...
    public void MainCodeBlock() {
        ...
        label = new JLabel("<html>Well, farewell, for now..</html>", SwingConstants.CENTER);
    ...
    public boolean startdainteraction3() {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == x) {
            ...
            if (prog == 0) {
                label.setText("<html>I represent your determination, don't thank me.</html>.");
                but1.setText("Next");
                prog++;
            } else if (prog == 1) {
                label.setText("<html>Thank yourself.</html>.");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(interaction3::new);
    }
}