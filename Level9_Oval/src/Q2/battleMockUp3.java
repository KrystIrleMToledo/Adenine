...
public class battleMockUp3 implements KeyListener{
    long beginning;
    ...
    public battleMockUp3(){
        frame = new JFrame("how are you po sir?");
        
        defaultTexture = new ImageIcon("Images/back.png");
        
        defaultPlayer = new ImageIcon("Images/boyidle3.png");
        
        defaultOpp = new ImageIcon("Images/snake3.png"); //transparent, final boss
        ...
        defaultOpp = new ImageIcon(defaultOpp.getImage().getScaledInstance((frameWidth / mapWidth),(frameHeight / mapHeight), Image.SCALE_DEFAULT));
    ...
    public boolean startBattleAndWait3() {
        SwingUtilities.invokeLater(this::setFrame3);
    ...
    public void keyPressed(KeyEvent ke) {
        ...
        switch(ke.getKeyCode()) {
            case KeyEvent.VK_RIGHT -> {
                ...
                if (oh == 0) {
                    hasParried = false;      // enemy cannot hit back
    ...
    public static void main(String[] args) {
        battleMockUp3 sg = new battleMockUp3();
        sg.setFrame3();
    }   
}
