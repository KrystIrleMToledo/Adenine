...
public class ADMINBLDG implements KeyListener {
    ...
    private void loadSprites() {
        ...
        if (playerType.equals("girl")) {
            ...
            pU1 = load("Images/player3.png");
            pU2 = load("Images/player9.png");
            pD1 = load("Images/player1.png");
            pD2 = load("Images/player2.png");
            pL1 = load("Images/player6.png");
            pL2 = load("Images/player8.png");
            pR1 = load("Images/player5.png");
            pR2 = load("Images/player7.png");
        }
    }
