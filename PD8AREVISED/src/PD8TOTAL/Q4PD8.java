...
class InvalidInputException1 extends Exception {
    public InvalidInputException1(String message) { super(message); }
}
...
public class Q4PD8 extends JPanel {
    ...
    public Q4PD8(PD8 window) {
        ...
        addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                ...
                } catch (InvalidInputException1 ex) {
    ...
    private void validateAndHandleInput(KeyEvent e) throws InvalidInputException1 {
        ...
        if (!isMove && key != KeyEvent.VK_E) throw new InvalidInputException1("Use WASD and 'E'.");
    ...
    SwingUtilities.invokeLater(() -> {
        ...
        // create this map panel
        Q4PD8 panel = new Q4PD8(frame);
