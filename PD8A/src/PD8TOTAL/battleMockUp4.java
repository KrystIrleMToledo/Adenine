...
public class battleMockUp4 implements KeyListener{
    long beginning;
    ...
    public battleMockUp4(){
        ...
        defaultOpp = new ImageIcon("Images/gr10/tambaltilefight.png"); //transparent, final boss
    ...
    public boolean startBattleAndWait4() {
    ...
    public static void main(String[] args) {
        battleMockUp4 sg = new battleMockUp4();
        sg.setFrame();
    }   
}
