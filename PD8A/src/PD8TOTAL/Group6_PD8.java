...
public class Group6_PD8 implements KeyListener {
    ...
    private void loadPlayerSprites() {
        ...
        // IDLE
        playerIdle1 = new ImageIcon(new ImageIcon("Images/gr6/" + prefix + "idle1.png").getImage().getScaledInstance(frameWidth/mapWidth, frameHeight/mapHeight, Image.SCALE_DEFAULT));
        playerIdle2 = new ImageIcon(new ImageIcon("Images/gr6/" + prefix + "idle2.png").getImage().getScaledInstance(frameWidth/mapWidth, frameHeight/mapHeight, Image.SCALE_DEFAULT));
        playerIdle3 = new ImageIcon(new ImageIcon("Images/gr6/" + prefix + "idle3.png").getImage().getScaledInstance(frameWidth/mapWidth, frameHeight/mapHeight, Image.SCALE_DEFAULT));
        playerIdle4 = new ImageIcon(new ImageIcon("Images/gr6/" + prefix + "idle4.png").getImage().getScaledInstance(frameWidth/mapWidth, frameHeight/mapHeight, Image.SCALE_DEFAULT));

        // WALK
        playerWalk1 = new ImageIcon(new ImageIcon("Images/gr6/" + prefix + "walk1.png").getImage().getScaledInstance(frameWidth/mapWidth, frameHeight/mapHeight, Image.SCALE_DEFAULT));
        playerWalk2 = new ImageIcon(new ImageIcon("Images/gr6/" + prefix + "walk2.png").getImage().getScaledInstance(frameWidth/mapWidth, frameHeight/mapHeight, Image.SCALE_DEFAULT));
        playerWalk3 = new ImageIcon(new ImageIcon("Images/gr6/" + prefix + "walk3.png").getImage().getScaledInstance(frameWidth/mapWidth, frameHeight/mapHeight, Image.SCALE_DEFAULT));
        playerWalk4 = new ImageIcon(new ImageIcon("Images/gr6/" + prefix + "walk4.png").getImage().getScaledInstance(frameWidth/mapWidth, frameHeight/mapHeight, Image.SCALE_DEFAULT));
        playerWalk5 = new ImageIcon(new ImageIcon("Images/gr6/" + prefix + "walk5.png").getImage().getScaledInstance(frameWidth/mapWidth, frameHeight/mapHeight, Image.SCALE_DEFAULT));
        playerWalk6 = new ImageIcon(new ImageIcon("Images/gr6/" + prefix + "walk6.png").getImage().getScaledInstance(frameWidth/mapWidth, frameHeight/mapHeight, Image.SCALE_DEFAULT));
        playerWalk7 = new ImageIcon(new ImageIcon("Images/gr6/" + prefix + "walk7.png").getImage().getScaledInstance(frameWidth/mapWidth, frameHeight/mapHeight, Image.SCALE_DEFAULT));
        playerWalk8 = new ImageIcon(new ImageIcon("Images/gr6/" + prefix + "walk8.png").getImage().getScaledInstance(frameWidth/mapWidth, frameHeight/mapHeight, Image.SCALE_DEFAULT));
...
class GameObject1{
    ...
    public GameObject1(int p){ position=p; }
...
class Player extends GameObject1{
...
class Flower extends GameObject1{
