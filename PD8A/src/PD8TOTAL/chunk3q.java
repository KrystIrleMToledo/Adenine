 ...
 * @author USER
 */
public class chunk3q implements ActionListener{
    JFrame frame;
    JLabel label;
    JButton d;
    JButton p;
    ...
    public void MainCodeBlock() {
        ...
        d = new JButton("keratin");
        p = new JButton("chitin");
        t = new JButton("lipids");
        a = new JButton("gelatin");
        p.addActionListener(this);
        d.addActionListener(this);
        t.addActionListener(this);
        a.addActionListener(this);
        frame.setLayout(new GraphPaperLayout(new Dimension(12, 12)));
        label = new JLabel("What is the cell wall of fungi made off?", SwingConstants.CENTER);
    ...
    public boolean startdaquestion3() {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(chunk3q::new);
    }
}