...
public class battleMockUp1 implements KeyListener{
    long beginning;
    ...
    public battleMockUp1(){
        ...
        defaultOpp = new ImageIcon("Images/gr9/snake3.png"); //transparent, final boss
    ...
    public boolean startBattleAndWait1() {
    ...
    public static void main(String[] args) {
        battleMockUp1 sg = new battleMockUp1();
        sg.setFrame();
    }   
}
