 ...
 * @author USER
 */
public class chunk2q implements ActionListener{
    JFrame frame;
    JLabel label;
    JButton d;
    JButton p;
    ...
    public void MainCodeBlock() {
        ...
        label = new JLabel("5x + 10 = 5", SwingConstants.CENTER);
    ...
    public boolean startdaquestion2() {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(chunk2q::new);
    }
}