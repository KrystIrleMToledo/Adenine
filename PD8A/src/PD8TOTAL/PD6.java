...
public class PD6 implements KeyListener {
    ...
    private void loadImages() {
        for (int row = 1; row <= mapHeight; row++) {
            for (int col = 1; col <= mapWidth; col++) {
                ...
                ImageIcon icon = new ImageIcon("Images/gr5/row-" + row + "-column-" + col + ".png");
    ...
    private void loadAnimations() {
        ...
        if (playerType.equals("girl")) {
            walkDown  = loadAnimation("girlwalk1.png", "girlwalk2.png"); 
        walkRight = loadAnimation("girlwalk5.png", "girlwalk7.png");   
        walkLeft  = loadAnimation("girlwalk6.png", "girlwalk8.png"); 
        walkUp    = loadAnimation("girlwalk3.png", "girlwalk4.png"); 
        idles     = loadAnimation(/*d*/"girlidle1.png", /*l*/"girlidle3.png", /*r*/"girlidle4.png", /*u*/"girlidle2.png");
        } else {
        walkDown  = loadAnimation("boywalk1.png", "boywalk2.png"); 
        walkRight = loadAnimation("boywalk5.png", "boywalk7.png");   
        walkLeft  = loadAnimation("boywalk6.png", "boywalk8.png"); 
        walkUp    = loadAnimation("boywalk3.png", "boywalk4.png"); 
        idles     = loadAnimation(/*d*/"boyidle1.png", /*l*/"boyidle3.png", /*r*/"boyidle4.png", /*u*/"boyidle2.png");
        }
    ...
    private ImageIcon[] loadAnimation(String... filenames) {
        ...
        for (int i = 0; i < filenames.length; i++) {
            ImageIcon raw = new ImageIcon("Images/gr5/" + filenames[i]);
