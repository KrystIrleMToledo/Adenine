...
public class Q4PD8 extends JPanel {
    ...
    private void loadAssets() {
        boyidlefront = loadImg("Images/PD8_assets/boyidlefront.png");
        boyidleback = loadImg("Images/PD8_assets/boyidleback.png");
        directionalFrames = new HashMap<>();
        directionalFrames.put(KeyEvent.VK_S, new ImageIcon[]{loadImg("Images/PD8_assets/boywalkfront1.png"), loadImg("Images/PD8_assets/boywalkfront2.png")});
        directionalFrames.put(KeyEvent.VK_W, new ImageIcon[]{loadImg("Images/PD8_assets/boywalkbehind1.png"), loadImg("Images/PD8_assets/boywalkbehind2.png")});
        directionalFrames.put(KeyEvent.VK_A, new ImageIcon[]{loadImg("Images/PD8_assets/leftfrontprof.png"), loadImg("Images/PD8_assets/leftbackprof.png")});
        directionalFrames.put(KeyEvent.VK_D, new ImageIcon[]{loadImg("Images/PD8_assets/rightfrontprof.png"), loadImg("Images/PD8_assets/rightbackprof.png")});
        tile = loadImg("Images/PD8_assets/40.png"); wall = loadImg("Images/PD8_assets/41.png");
        shelf_L = loadImg("Images/PD8_assets/2.png"); shelf_R = loadImg("Images/PD8_assets/3.png");
        shelf_L2 = loadImg("Images/PD8_assets/12.png"); shelf_R2 = loadImg("Images/PD8_assets/13.png");
        shelf_L3 = loadImg("Images/PD8_assets/8.png"); shelf_R3 = loadImg("Images/PD8_assets/9.png");
        oldmanIcon = loadImg("Images/PD8_assets/oldman.png"); oldmanDesk = loadImg("Images/PD8_assets/1.png");
    }
    ...
    SwingUtilities.invokeLater(() -> {
        ...
        PD8 testWindow = new PD8();   // create parent frame
        Q4PD8 panel = new Q4PD8(testWindow);

        testWindow.setContentPane(panel);
        testWindow.pack();
