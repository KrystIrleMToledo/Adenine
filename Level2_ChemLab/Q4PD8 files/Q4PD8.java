...
import java.io.*;
import java.util.*;
import java.util.List; // Added explicit List import
...
public class Q4PD8 extends JPanel {
        ...
        if (file.exists()) {
            try (BufferedReader reader = new BufferedReader(new FileReader(file))) {
                ...
                while ((line = reader.readLine()) != null) {
                    ...
                    } else if (line.matches("\\d+")) { // Fix for your "19" raw number file
    ...
    // --- FIX FOR LINE 211 ERROR ---
    private void checkRNGStall() {
        // Changed List::isEmpty to a lambda to avoid ambiguous method references
    ...
    private void loadAssets() {
        boyidlefront = loadImg("PD6/boyidlefront.png");
        boyidleback = loadImg("PD6/boyidleback.png");
        directionalFrames = new HashMap<>();
        directionalFrames.put(KeyEvent.VK_S, new ImageIcon[]{loadImg("PD6/boywalkfront1.png"), loadImg("PD6/boywalkfront2.png")});
        directionalFrames.put(KeyEvent.VK_W, new ImageIcon[]{loadImg("PD6/boywalkbehind1.png"), loadImg("PD6/boywalkbehind2.png")});
        directionalFrames.put(KeyEvent.VK_A, new ImageIcon[]{loadImg("PD6/leftfrontprof.png"), loadImg("PD6/leftbackprof.png")});
        directionalFrames.put(KeyEvent.VK_D, new ImageIcon[]{loadImg("PD6/rightfrontprof.png"), loadImg("PD6/rightbackprof.png")});
        tile = loadImg("PD6/40.png"); wall = loadImg("PD6/41.png");
        shelf_L = loadImg("PD6/2.png"); shelf_R = loadImg("PD6/3.png");
        shelf_L2 = loadImg("PD6/12.png"); shelf_R2 = loadImg("PD6/13.png");
        shelf_L3 = loadImg("PD6/8.png"); shelf_R3 = loadImg("PD6/9.png");
        oldmanIcon = loadImg("PD6/oldman.png"); oldmanDesk = loadImg("PD6/1.png");
    }
    ...
    public static void main(String[] args) {
        JFrame f = new JFrame("Stockroom Management System - PSHS-SMC");
        f.add(new Q4PD8()); f.pack(); f.setLocationRelativeTo(null);
